        ...
        <div class="container">
            ...
            <form action="{{ route('admin.product.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" value="{{ $product->price }}" name="price" class="form-control"
                            id="staticName" placeholder="Enter Your Category Title">
                        @error('price')
                            <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" value="{{ $product->descount }}" name="descount" class="form-control"
                            id="staticName" placeholder="Enter Your product descount">
                        @error('descount')
                            <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $product->rating }}" name="rating" class="form-control"
                            id="staticName" placeholder="Enter Your Category Title">
                        @error('rating')
                            <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $product->small_desc }}" name="small_desc" class="form-control"
                            id="staticName" placeholder="Enter Your Category Title">
                        @error('small_desc')
                            <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ $product->information }}" name="information" class="form-control"
                            id="staticName" placeholder="Enter Your Category Title">
                        @error('information')
                            <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="d-flex form-group">
                    ...
                    <select name="category_id" class="form-control" id="category_id">
                        @foreach ($Category as $cat)
                            <option value="{{ $cat->id }}" @if ($cat->id == $product->category_id) checked @endif>
                                {{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="d-flex mb-3" style="justify-content: start;">
                    ...
                    {{--  <input type="hidden" name="productsSizeId" value="{{ $productsSize->id}}">  --}}
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input value="XS" name="size[XS]" type="checkbox" class="custom-control-input"
                            id="size-1">
                        <label class="custom-control-label" for="size-1">XS</label>
                    </div>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input value="S" name="size[S]" type="checkbox" class="custom-control-input"
                            id="size-2">
